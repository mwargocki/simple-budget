...
Utworz diagramy autentykacji zgodnie z poniższymi regułami i zapisz je w .ai/auth/
...
Umieść swoją analizę wewnątrz tagów <authentication_analysis>. W tej analizie:
